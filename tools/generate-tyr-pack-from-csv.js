...
function main() {
  ...
  const pack = {
    ...
    author: 'Community',
    source_note: `Generated from current 10e CSV exports. This pack includes Tyranid detachments ${detachmentNames.join(', ')}. Boarding Actions detachments are intentionally excluded. Rules text is extracted and normalized for in-app prompting; check official publications for authoritative wording.`,
    units,
    stratagems,
